...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-LN3JEVFW.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-32N2XFAF.js"), act = await getAct();
...
//# sourceMappingURL=chunk-RELUBWF3.js.map
