...
<reference>
@C:/VS Code/Akza/akza-client/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/VS Code/Akza/akza-client/.claude/get-shit-done/references/user-profiling.md` to load:
