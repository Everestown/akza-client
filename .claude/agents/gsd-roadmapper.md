...
Reference full template: `C:/VS Code/Akza/akza-client/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/VS Code/Akza/akza-client/.claude/get-shit-done/templates/state.md`.
