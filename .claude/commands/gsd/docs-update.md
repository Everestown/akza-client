...
<execution_context>
@C:/VS Code/Akza/akza-client/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/VS Code/Akza/akza-client/.claude/get-shit-done/workflows/docs-update.md end-to-end.
