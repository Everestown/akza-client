...
<execution_context>
@C:/VS Code/Akza/akza-client/.claude/get-shit-done/workflows/new-workspace.md
@C:/VS Code/Akza/akza-client/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/VS Code/Akza/akza-client/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
