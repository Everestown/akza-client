...
<execution_context>
@C:/VS Code/Akza/akza-client/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @C:/VS Code/Akza/akza-client/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
