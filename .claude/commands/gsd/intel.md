...
Intel system is disabled. To activate:
  ...
  node C:/VS Code/Akza/akza-client/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/VS Code/Akza/akza-client/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/VS Code/Akza/akza-client/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/VS Code/Akza/akza-client/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: C:/VS Code/Akza/akza-client/.claude/get-shit-done/bin/gsd-tools.cjs
